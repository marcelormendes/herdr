...
#[derive(Debug)]
pub enum AppEvent {
    /// A queued prompt failed before submission completed; discard staged files.
    AgentPromptSubmissionFailed {
    ...
    AgentSessionReported {
        ...
        seq: Option<u64>,
        session_ref: Option<crate::agent_resume::AgentSessionRef>,
        transcript_ref: Option<crate::agent_resume::TranscriptRef>,
