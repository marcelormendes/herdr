...
pub(crate) fn request_changes_ui(request: &Request) -> bool {
    matches!(
        ...
        Method::ServerReloadConfig(_)
            ...
            | Method::AgentConversationReport(_)
            | Method::AgentConversationRespond(_)
            | Method::AgentAttachmentBegin(_)
            | Method::AgentAttachmentChunk(_)
            | Method::AgentAttachmentFinish(_)
            | Method::AgentAttachmentAbort(_)
